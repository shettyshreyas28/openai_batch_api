...
* Specify the input_file to be processed and the output file after merging the API call outputs
* The columns containing the unique identifier in the input file and the column containing the input data to model are to be specified in *id_column* and *content_column* respectively
